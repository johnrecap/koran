...
part 'src/pages/continuous_surah_content.dart';
part 'src/pages/continuous_surah_scroll_policy.dart';
...
part 'src/quran/core/services/page_snapshot_cache_service.dart';
...
part 'src/quran/data/models/quran_paging_performance_profile.dart';
...
part 'src/quran/presentation/widgets/page_motion_surface.dart';
