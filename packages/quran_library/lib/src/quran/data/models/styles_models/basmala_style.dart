...
class BasmalaStyle {
  ...
  BasmalaStyle copyWith({
    ...
    return BasmalaStyle(
      ...
      basmalaFontSize: basmalaFontSize ?? this.basmalaFontSize,
      verticalPadding: verticalPadding ?? this.verticalPadding,
    );
  }

  BasmalaStyle merge(BasmalaStyle? override) {
    if (override == null) {
      return this;
    }

    return copyWith(
      basmalaColor: override.basmalaColor,
      basmalaFontSize: override.basmalaFontSize,
      verticalPadding: override.verticalPadding,
    );
  }
}
